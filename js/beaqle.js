...
AbxTest.prototype.createTestDOM = function (TestIdx) {
        ...
        // add reference        
        row  = tab.insertRow(-1);
        // row.innerHTML = "Which voice is closest to X? Chose Fair if both voices are the same."
        row.insertCell(-1);
        
        fileID = this.TestState.FileMappings[TestIdx].A;

        row.innerHTML = "Press buttons to start/stop playback.";
        cell[0] = row.insertCell(-1);
        ...
        cell[2].innerHTML = "Fair"
        cell[3]  =row[2].insertCell(-1);
        cell[3].innerHTML = "B"


        row[3]  = tab.insertRow(-1);
        cell[1] = row[3].insertCell(-1);
        cell[2] = row[3].insertCell(-1);
        cell[2].innerHTML = "<input type='radio' name='SimilaritySelection' id='SimSelectA'/>";
        cell[3] = row[3].insertCell(-1);
        cell[3].innerHTML = "<input type='radio' name='SimilaritySelection' id='SimFair'/>";
        cell[4] = row[3].insertCell(-1);
        cell[4].innerHTML = "<input type='radio' name='SimilaritySelection' id='SimSelectB'/>";
...
AbxTest.prototype.readRatings = function (TestIdx) {
    ...
    if (this.TestState.Ratings[TestIdx] === "A") {
        $("#SimSelectA").prop("checked", true);
    } else if (this.TestState.Ratings[TestIdx] === "B") {
        $("#SimSelectB").prop("checked", true);
    } else if (this.TestState.Ratings[TestIdx] === "Fair") {
        $("#SimFair").prop("checked", true);
    }
}

AbxTest.prototype.saveRatings = function (TestIdx) {

    if ($("#SimSelectA").prop("checked"))  {
        this.TestState.Ratings[TestIdx] = "A";
    } else if ($("#SimSelectB").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "B";
    } else if($("#SimFair").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "Fair";
    }
}
...
AbTest.prototype.createTestDOM = function (TestIdx) {
        ...
        cell[1] = row[3].insertCell(-1);
        cell[2] = row[3].insertCell(-1);
        cell[2].innerHTML = "<input type='radio' name='selection' id='selectA'/>";
        cell[3] = row[3].insertCell(-1);
        cell[3].innerHTML = "<input type='radio' name='selection' id='Fair'/>";
        cell[4] = row[3].insertCell(-1);
        cell[4].innerHTML = "<input type='radio' name='selection' id='selectB'/>";
...
// inherit from ListeningTest
function SimTest(TestData) {
    ListeningTest.apply(this, arguments);
}
SimTest.prototype = new ListeningTest();
SimTest.prototype.constructor = SimTest;


// implement specific code
SimTest.prototype.createTestDOM = function (TestIdx) {
        ...
        row  = tab.insertRow(-1);
        cell[0] = row.insertCell(-1);
        cell[0].innerHTML = '<p>Please listen to both A and B</p>'
        cell[1] = row.insertCell(-1);
        cell[1].innerHTML = '<button id="play'+fileID+'Btn" class="playButton" rel="'+fileID+'">A</button>';
        this.addAudio(TestIdx, fileID, fileID);
        ...
        row[1]  = tab.insertRow(-1);
        cell[0] = row[1].insertCell(-1);
        cell[0].innerHTML = '<p>Are the two voices the same or different?</p>'
        cell[1] = row[1].insertCell(-1);
        cell[1].innerHTML = "<input type='radio' name='ItemSelection' id='diff_sure'/><label for='diff_sure'>Different (sure)</label>";
        cell[2] = row[1].insertCell(-1);
        cell[2].innerHTML = "<input type='radio' name='ItemSelection' id='diff_unsure'/><label for='diff_unsure'>Different (unsure)</label>";  
        cell[3] = row[1].insertCell(-1);
        cell[3].innerHTML = "<input type='radio' name='ItemSelection' id='same_unsure'/><label for='same_unsure'>Same (unsure)</label>";
        cell[4] = row[1].insertCell(-1);
        cell[4].innerHTML = "<input type='radio' name='ItemSelection' id='same_sure'/><label for='same_sure'>Same (sure)</label>";        
...
SimTest.prototype.readRatings = function (TestIdx) {
...
SimTest.prototype.saveRatings = function (TestIdx) {
    if ($("#diff_sure").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "1";
    }
    if ($("#diff_unsure").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "2";
    }
    if ($("#same_unsure").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "3";
    }
    if ($("#same_sure").prop("checked")) {
        this.TestState.Ratings[TestIdx] = "4";
    }
}

SimTest.prototype.formatResults = function () {
